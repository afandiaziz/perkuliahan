                ...
                <div class="card py-4 px-3">
                    <div class="card-body">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label for="captcha" class="text-capitalize">captcha</label>
                                <div class="my-2"><img src="captcha.php" alt="" class="rounded-pill"></div>
                                <input type="text" class="form-control text-uppercase" id="captcha" name="captcha" required autocomplete="off" placeholder="captcha">
                            </div>
                            <div class="form-group mb-2">
