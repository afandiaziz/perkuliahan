                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title fw-bold mb-0 h3">
                            ...
                            <span class="text-center ms-3">Operator Increment Decrement</span>
                        </div>
                    </div>
                    <div class="card-body fs-6">
                        ...
                        <?php
                        $a = 5;
                        echo '<h5>Post-Increment</h5>';
                        echo "$a = " . ($a) . "<br>";
                        echo "\$a akan bernilai $a = " . ($a++) . " (Operasi \$a++) <br>";
                        echo "\$a akan bernilai $a = " . ($a) . "<br><hr>";

                        $a = 5;
                        echo '<h5>Pre-Increment</h5>';
                        echo "$a = " . ($a) . "<br>";
                        echo "\$a akan bernilai $a = " . (++$a) . " (Operasi ++\$a) <br>";
                        echo "\$a akan bernilai $a = " . ($a) . "<br><hr>";

                        $a = 5;
                        echo '<h5>Post-Decrement</h5>';
                        echo "$a = " . ($a) . "<br>";
                        echo "\$a akan bernilai $a = " . ($a--) . " (Operasi \$a--) <br>";
                        echo "\$a akan bernilai $a = " . ($a) . "<br><hr>";

                        $a = 5;
                        echo '<h5>Pre-Decrement</h5>';
                        echo "$a = " . ($a) . "<br>";
                        echo "\$a akan bernilai $a = " . (--$a) . " (Operasi --\$a) <br>";
                        echo "\$a akan bernilai $a = " . ($a) . "<br><hr>";
                        ?>
