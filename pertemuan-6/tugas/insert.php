                ...
                <div class="card-body">
                    ...
                    <form action="process-insert.php" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <br>
                            <label for="ljk">
                                <input id="ljk" type="radio" value="L" name="jk" required> Laki-Laki
                            </label> &nbsp;
                            <label for="pjk">
                                <input id="pjk" type="radio" value="P" name="jk" required> Perempuan
                            </label>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="agama" class="form-control" required name="agama" autocomplete="off">
                        </div>
                        <div class="form-group mb-3">
                            <label for="asal" class="mb-2">Asal Sekolah</label>
                            <input type="text" id="asal" class="form-control" required name="asal" autocomplete="off">
                        </div>
