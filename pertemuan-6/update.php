...
$sql = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE id='$_GET[id]'");
                ...
                <div class="card-body">
                    ...
                    <form action="process-update.php" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" id="nim" class="form-control" required value="<?= $item['nim'] ?>" name="nim" autocomplete="off">
                        </div>
                        <div class="form-group mb-3">
