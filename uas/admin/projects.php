...
if ($type) {
    $sql = "SELECT * FROM projects WHERE $type LIKE '%$q%'";
} else {
...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a href="add_project.php" class="btn btn-primary">Tambah Data</a>
        </div>
        <div class="card-body">
                    ...
                    <div class="d-flex">
                        <form action="" method="get">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-secondary" type="button" onclick="location.href='projects.php'">Reset</button>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-sm table-hover table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td><img width="80" src="../images/<?= $item['image'] ?>"></td>
                                    <td><?= $item['title'] ?></td>
                                    <td><?= $item['description'] ?></td>
                                    <td class="text-center align-middle">
                                        <a href="edit_project.php?id=<?= $item['id'] ?>" class="btn btn-info">Edit</a>
                                        <a href="delete_project.php?id=<?= $item['id'] ?>" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                            <?php endwhile;
                        else : ?>
